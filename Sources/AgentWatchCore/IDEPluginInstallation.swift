...
public enum IDEPluginInstallation {
    ...
    /// comparison will say so. Anything that is not a number compares as text, which is what
    /// happens to `0.2.0-rc1` and is good enough for choosing between two files.
