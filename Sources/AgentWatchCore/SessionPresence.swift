...
///
/// It had a companion, `canFocusHost`, which decided whether the row's `↗` was grey.
/// That question is gone: the button is always pressable and `SessionLocator` says how
/// far it reaches.
