...
1. Пакет для раздачи — **сделан наполовину, и вторая половина стоит на решении, которое не наше.**
   ...
   сказанная и в README, и в примечаниях к релизу. Проверка новой версии при запуске ждёт
   публичного репозитория: у приватного GitHub API требует токена. Разбор — в
   [дистрибуции](distribution.md).
