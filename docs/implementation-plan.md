...
- расширенная иконка в строке меню: внешний вид и поведение утверждены на экране и описаны в
  [`menu-bar-icon-design.md`](menu-bar-icon-design.md), не решён один вопрос — механизм дыхания
  (кадры по таймеру против анимации слоя); он решается пробой, с которой начинается реализация;
