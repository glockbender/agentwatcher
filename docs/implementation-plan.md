...
1. **Лицензия — есть.** `LICENSE` с MIT лежит в корне с первого коммита. На Marketplace лицензия
   обязательна, и открытая снимает возню с собственным пользовательским соглашением: достаточно
   назвать её при загрузке и дать ссылку на исходники.
