...
исчезает. Ширина элемента меняется тремя ступенями — 65, 73 и 81 pt, — и только когда число в
колонке переходит через 9. Первым пунктом меню те же четыре числа сказаны словами; ими же
