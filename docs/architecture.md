...
за `⌥⌘,`, получил бы отказ и не понял, в клавише дело или в модификаторах.

**Конфликта с чужим приложением не бывает**: два процесса спокойно регистрируют одно сочетание, и
нажатие получают оба — замерено, разбор в [ADR-0008](adr/0008-the-global-shortcut-goes-through-carbon.md).
