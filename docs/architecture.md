...
(`awaitedActivityID`): его снимает завершение или ошибка именно этого вызова, начало нового вызова
по хуку или конец хода. Поздно прочитанное начало advisor из транскрипта ожидание не снимает. Завершение параллельного вызова — не снимает. Если идентификатора ожидаемого вызова нет,
принимается только окончание не старше последнего наблюдения; старая запись прошлого хода
не может ответить на новый диалог. Причина простая: ход остановлен, пока
