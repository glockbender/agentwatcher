...
Четыре группы: лампа (строка на фазу — название, цвет, движение, и подсказка из колонки «Значение»
таблицы §7), фон (палитра из десяти), непрозрачность и размер. Кнопка возвращает лампе вид
приложения.
