...
угол строки, где живёт её `×`. Кнопка там есть и приглушённой, не только рабочей, так что капсула
...
кнопки, в которую можно попасть. Замерено на нижней целиком видимой строке: раньше капсула закрывала
сам знак `×` целиком и от рамки кнопки оставалась только прозрачная кромка; теперь открыты 14 точек
её высоты из 22, и знак виден. Вниз капсула опускается ровно настолько, насколько позволяет то, что
...
точки кнопка в этом случае и открыта меньше. Поле вокруг надписи минимальное, шрифт меньше всего
